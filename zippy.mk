...
# ==== Tcl/Tk bundled packages (sqlite3, tdbc, thread, etc.) ====
...
$(BASEDIR)/$(BIN_NAME): $(BASE_INTERP) $(DEP_STAMPS) $(BUILD_TCL) $(APP_DIR)/main.tcl
	$(TCLSH) $(BUILD_TCL) $(SHELL_TYPE) $(BASEDIR) $@ $(APP_DIR) $(_EXCLUDES_CSV) $(DEP_LIBS) $(TCL_PKG_LIBS)
endif
...
$(BASEDIR)/wish: $(WISH) $(DEP_STAMPS) $(BUILD_TCL)
	$(TCLSH) $(BUILD_TCL) wish $(BASEDIR) $@ "" "" $(DEP_LIBS) $(TCL_PKG_LIBS)

tclsh: $(BASEDIR)/tclsh

$(BASEDIR)/tclsh: $(TCLSH) $(DEP_STAMPS) $(BUILD_TCL)
	$(TCLSH) $(BUILD_TCL) tclsh $(BASEDIR) $@ "" "" $(DEP_LIBS) $(TCL_PKG_LIBS)
